                        ...
                        {shoppingCart.map((item,index)=>{
                            return(
                                ...
                                <tr>
                                    ...
                                    <td><button className='btn text-dark' onClick={()=>dispatch({type:"Inc",id:item.id,product:item})}><i className="material-icons">add</i></button></td>
                                    <td>{item.qty}</td>
                                    <td><button className='btn text-dark' onClick={()=>dispatch({type:"Dec",id:item.id,product:item})}><i className="material-icons">remove</i></button></td>
